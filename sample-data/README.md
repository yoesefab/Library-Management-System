...
- `backend/src/main/resources/demo/product-images/`: 15 couvertures originales associées aux SKU synthétiques du catalogue.
...
3. Appeler `POST /api/admin/demo-data/catalog` pour créer les référentiels, produits, stocks initiaux et couvertures. L'opération est idempotente et ne remplace pas une image déjà personnalisée.
