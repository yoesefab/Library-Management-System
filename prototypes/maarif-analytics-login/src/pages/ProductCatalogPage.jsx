...
import { CATALOG_PERMISSIONS, CATALOG_PRODUCTS, formatMad } from "../shared/catalogData.js";
...
export function ProductCatalog({ onCreate, onEdit, onView, role = "Gestionnaire" }) {
